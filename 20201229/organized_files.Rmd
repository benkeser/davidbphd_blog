...
![Monica from friends claiming to have won awards for her organizational skills](https://github.com/benkeser/davidbphd_blog/blob/main/20201229/img/monica.gif?raw=true)
...
cat toy_project/Makefile | head -5
```
...
cat toy_project/R/make_report.R
```
...
cat toy_project/data/biomarkers.txt
```

We also have `clinical.txt`. 

```{bash, show-clinical-data, echo = FALSE, comment = ""}
cat toy_project/data/clinical.txt
```
...
cat toy_project/R/make_summary_stats.R
```
...
sed -n '12,16p' toy_project/Makefile
```
...
I would be glad to hear from you with your own tips and tricks for organization. Leave a comment below or give me a shout on Twitter [\@biosbenk](https://twitter.com/biosbenk).
